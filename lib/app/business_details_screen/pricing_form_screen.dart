                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text(
                                    "Only Image".tr,
                                    textAlign: TextAlign.center,
                                    style: TextStyle(color: themeChange.getThem() ? AppThemeData.greyDark04 : AppThemeData.grey04, fontSize: 12, fontFamily: AppThemeData.semiboldOpenSans),
                                  ),
                                ],
                              ),
                            ),
                                        ...
                                        children: [
                                          ClipRRect(
                                            ...
                                            child: controller.images[index].runtimeType == XFile
                                                ? Image.file(File(controller.images[index].path), fit: BoxFit.cover, width: 100, height: 100)
                                                : NetworkImageWidget(imageUrl: controller.images[index], fit: BoxFit.cover, width: 100, height: 100),
                                          ),
                                          Positioned(
                                            top: 8,
                                            right: 8,
                                            child: InkWell(
                                              ...
                                              child: ClipOval(
                                                child: Container(
                                                  ...
                                                  child: Padding(padding: const EdgeInsets.all(5.0), child: Constant.svgPictureShow("assets/icons/delete-one.svg", AppThemeData.red02, 20, 20)),
                                                ),
                                              ),
                                            ),
                                          ),
